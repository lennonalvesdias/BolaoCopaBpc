    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            using (var serviceScope = app.ApplicationServices.GetService<IServiceScopeFactory>().CreateScope())
            {
                ...
                var admin = BolaoContextService.Usuarios.Find(x => x.Email == "admin@bompracredito.com.br").FirstOrDefault();
                if (admin == null)
                {
                    var administrador = new Usuario("admin@bompracredito.com.br", "59778CB56ADACBBDB3C4532A170C197D", 99); // 9JES5O5LJOIbAq3836kjuyL3f474AgTA
